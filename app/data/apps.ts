...
export const apps: App[] = [
  ...
  { slug: 'joa', name: 'JoA', category: 'flutter', description: 'AI 이미지 생성 앱', api: ['Grok (xAI)'], iconUrl: '/apps/joa/icon.png', apkUrl: 'https://github.com/zzindori/wowhit-releases/releases/download/joa-v1.0.0/JoA.apk' },
  {
    slug: 'menuway',
    name: 'menuWay',
    category: 'flutter',
  ...
  { slug: 'txtfit', name: 'txtFit', category: 'flutter', description: '텍스트 분할 · 정제 유틸리티', iconUrl: '/apps/txtfit/icon.png', webUrl: 'https://zzindori.github.io/TxtFit-web/', apkUrl: 'https://github.com/zzindori/wowhit-releases/releases/download/txtfit-v1.0.0/txtFit.apk' },

...
export const prints: Print[] = [
  ...
  {
    slug: 'chicago-bears-keychain',
    name: 'Chicago Bears Keychain',
    description: '시카고 베어스 로고 키링',
    category: 'accessory',
    imageUrl: '/prints/chicago-bears-keychain.jpg',
  },
  {
    slug: 'hellokitty-bears-keychain',
    name: 'Hello Kitty × Bears',
    description: '헬로키티 시카고 베어스 키링',
    category: 'accessory',
    imageUrl: '/prints/hellokitty-bears-keychain.jpg',
  },
  {
    slug: 'boston-token',
    name: 'Boston Token',
    description: 'Boston 로고 3D 프린트 토큰',
    category: 'accessory',
    imageUrl: '/prints/boston-token.jpg',
  },
  {
